defmodule Membrane.H26x.ParameterSetCache do
  @moduledoc false

  # Caches the parameter set NALus (VPS/SPS/PPS) of a stream, keyed by their type
  ...
  @spec put(t(), [NALu.t()]) :: t()
  def put(cache, parameter_sets) do
    Enum.reduce(parameter_sets, cache, fn new_ps, cache ->
